...
################################################################################
    ...
    tt = time.time()
    f = open("ResultoFireDetection.txt", "a")
    f.write("Fire detetcion model construct time : {0}\n".format(tt-start_time))
...
################################################################################
    ...
    if len(sys.argv) == 2:
        ...
        while (keepProcessing):
            ...
            totaltime = totaltime + stop_t
            f.write("Fire detetcion time : {0}\n".format(stop_t))
    ...
    f.write("Fire detetcion total time : {0}\n".format(totaltime))
    f.close()
################################################################################
